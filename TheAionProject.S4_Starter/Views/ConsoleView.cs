...
namespace TheAionProject
{
    ...
    public class ConsoleView
    {
        ...
        public bool DisplaySpashScreen()
        {
            ...
            Console.WriteLine(tabSpace + @" _____ _            _____  _       _    _  _     _                  ");
            Console.WriteLine(tabSpace + @"|_   _| |          |  ___|| |     | |  | || \   / |                 ");
            Console.WriteLine(tabSpace + @"  | | | |__   ___  | |__  | |     | |  | | \ \ / /                  ");
            Console.WriteLine(tabSpace + @"  | | | '_ \ / _ \ |  __| | |     | |  | |  \ v /                   ");
            Console.WriteLine(tabSpace + @"  | | | | | |  __/ | |    | |____ | \__/ |  / /\ \                  ");
            Console.WriteLine(tabSpace + @"  \_/ |_| |_|\___| |_|    |______| \____/  |_/  \_|                 ");
            Console.WriteLine(tabSpace + @"                                                                    ");
            Console.WriteLine(tabSpace + @"                                                                    ");


            Console.WriteLine(tabSpace + @" _____ _ _       _  ______                                             ");
            ...
            Console.WriteLine(tabSpace + @"|_____|_|     \___|\______/   ()                                                     |__/ ");
        ...
        private static void InitializeDisplay()
        {
            ...
            Console.Title = "The Flux Engagement";
