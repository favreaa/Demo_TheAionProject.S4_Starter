...
namespace TheAionProject
{
    ...
    {
        public static List<string> HeaderText = new List<string>() { "The Flux Engagement" };
        public static List<string> FooterText = new List<string>() { "APF productions, 2017" };
        ...
        public static string MissionIntro()
        {
            ...
            "You have been hired by the Flux Engagement Committee " +
            "in its latest program to find rare artifacts throughout the universe  " +
            "You will search the universe for these rare artifacts" +
        ...
        {
            string messageBoxText =
            "You are now in the Flux Engagement headquarters " +
            "this is locted in the outskirts of the milky way galaxy " +
            "This is the biggest city on the edge of the milky way universe " +
            "This place is huge .\n" +
            " \n" +
        ...
        {
            string messageBoxText =
                $"{gametraveler.Name}, The Flux Engagment will need to know the name of the new location.\n" +
                " \n" +
